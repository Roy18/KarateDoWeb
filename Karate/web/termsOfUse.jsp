    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <s:if test="#session.userType==2"><li><s:a href="userPostulant">Eventos postulados</s:a></li></s:if>
            </ul>
            </div>
        </div>
    </div>
...
<div class="container">
    <div id="terms" class="row">
        ...
        <h3>Le solicitamos leer cuidadosamente los términos y condiciones del servicio que ofrece Karate Do Web</h3>
    </div>
</div>
<center>
<div class="col-md-8">
    <div class="op-text-block">
        <ol>
            <li>Tomar en cuenta que esta página difundirá sólo sobre este deporte.</li>
            <br> <li>Prohibido la distribución de contenidos inadecuados.</li>
            <br><li>No nos haremos responsables por cualquier altercado entre usuarios de este sitio web.</li>
            <br><li>Si son menores de edad deben estar bajo la supervisión de sus padres.</li>
...
<footer class="footer-bs">
    <div class="row">
        ...
        <div class="col-md-4 footer-nav animated fadeInUp">
            ...
            <div class="col-md-6">
                <ul class="pages">
                    <li><a href="aboutUs.jsp">Acerca de KDW</a></li>
